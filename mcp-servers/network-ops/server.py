...
from tools.bandwidth_excel_report_generate import register as register_bandwidth_excel_report_generate
...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "bandwidth_report_generate；生成带宽峰值、利用率、均值 Excel 日表时，使用 "
        "bandwidth_excel_report_generate；生成 VPDN 专线报告时，必须使用 vpdn_report_generate；"
...
register_bandwidth_excel_report_generate(mcp)
